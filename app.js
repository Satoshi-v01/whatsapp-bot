...
const reposicionRoutes = require('./src/routes/reposicion')
const cuentasTransferenciaRoutes = require('./src/routes/cuentasTransferencia')
const carritoWebRoutes = require('./src/routes/carritoWeb')
...
app.use('/api/reposicion', limiterGeneral, autenticar, reposicionRoutes)
app.use('/api/cuentas-transferencia', limiterGeneral, autenticar, cuentasTransferenciaRoutes)
app.use('/api/carrito-web', limiterGeneral, carritoWebRoutes)
...
app.use('/reposicion', limiterGeneral, autenticar, reposicionRoutes)
