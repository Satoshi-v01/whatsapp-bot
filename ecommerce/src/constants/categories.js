export const CATEGORIES = [
  {
    ...
    description: 'Alimento balanceado para perros en Paraguay.',
    color: '#ffa601',
    bg: '#fff8e6',
  },
  {
    ...
    description: 'Alimento para gatos, arena sanitaria y accesorios.',
    color: '#7c3aed',
    bg: '#f3eeff',
  },
  {
    ...
    description: 'Antiparasitarios, vitaminas y suplementos para perros y gatos en Paraguay.',
    color: '#0ea5e9',
    bg: '#e6f6ff',
  },
  {
    ...
    description: 'Correas, camas, comederos, bebederos y juguetes para perros y gatos en Paraguay.',
    color: '#f97316',
    bg: '#fff3e8',
  },
  {
    ...
    description: 'Shampoos, cepillos, toallitas y productos de grooming e higiene para mascotas en Paraguay.',
    color: '#10b981',
    bg: '#e8fdf4',
  },
  {
    ...
    description: 'Promociones y descuentos en alimentos balanceados y accesorios para mascotas en Paraguay.',
    color: '#dc2626',
    bg: '#fff0f0',
  },
]
