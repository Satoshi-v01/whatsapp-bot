...
const SOCIAL_LINKS = [
  ...
  {
    label: 'Facebook',
    href: 'https://facebook.com/sosabulls',
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-3">
              <div
                className="w-10 h-10 flex items-center justify-center font-display text-sm font-black text-white"
                style={{
            ...
            <p className="text-sm leading-relaxed" style={{ color: 'rgba(255,255,255,0.65)' }}>
              Tu tienda de confianza para productos de mascotas en Paraguay.
              Calidad premium, precios justos y entrega a domicilio.
            </p>
          ...
          <div>
            <h3 className="font-display text-lg text-white mb-4">Contacto</h3>
            <ul className="flex flex-col gap-3 text-sm" style={{ color: 'rgba(255,255,255,0.65)' }}>
      ...
      <div className="border-t" style={{ borderColor: 'rgba(255,255,255,0.08)' }}>
        <div className="container-base px-4 py-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-xs font-body" style={{ color: 'rgba(255,255,255,0.35)' }}>
            &copy; {year} Sosa Bulls. Todos los derechos reservados.
          </p>
          <p className="text-xs font-body" style={{ color: 'rgba(255,255,255,0.35)' }}>
            Hecho en Paraguay
          </p>
