...
const AVISO_PEDIDO_EXCLUSIVO = 'Algunos productos se pueden conseguir en el día, otros pueden tardar de 24 a 48 hs aproximadamente. El pedido se realiza con una seña del 20%.'
...
function PedidoExclusivoModal({ presentacionId, maxQty = 20, onClose }) {
          ...
          <div className="container-base">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16">
              ...
              >
                ...
                {outOfStock && presActual && (
                  <div className="flex flex-col gap-3">
                    <p className="text-sm rounded-xl p-3" style={{ backgroundColor: 'var(--color-primary-light)', color: 'var(--color-text)' }}>
                      {AVISO_PEDIDO_EXCLUSIVO}
                    </p>
                    <motion.button
                      onClick={() => setShowPedidoExclusivo(true)}
                      whileTap={{ scale: 0.97 }}
                      className="btn-primary w-full md:w-auto justify-center text-base py-4 px-8"
                    >
                      Hacer pedido
                ...
                {/* Sin ninguna presentacion cargada: no hay nada que pedir */}
                {outOfStock && !presActual && (
                  <button
                    disabled
                ...
                <AnimatePresence>
                  {showPedidoExclusivo && presActual && (
