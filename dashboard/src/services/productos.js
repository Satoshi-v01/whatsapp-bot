...
export async function actualizarPermiteFraccion(presentacionId, permite_fraccion) {
    const res = await api.patch(`/productos/presentaciones/${presentacionId}/fraccion`, { permite_fraccion })
    return res.data
}
